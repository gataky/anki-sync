...
class Config:
    ...
    def validate(self) -> bool:
        ...
        if self.audio_synthesizer == "elevenlabs" and not self.elevenlabs_api_key:
            errors.append("ELEVENLABS_API_KEY environment variable is required for ElevenLabs synthesizer")
...
def load_config_from_env() -> None:
    ...
    update_config(
        ...
        google_application_credentials=os.environ.get("GOOGLE_APPLICATION_CREDENTIALS", config.google_application_credentials),
        google_api_key=os.environ.get("GOOGLE_API_KEY", config.google_api_key),
        elevenlabs_api_key=os.environ.get("ELEVENLABS_API_KEY", config.elevenlabs_api_key),
